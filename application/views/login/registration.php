          ...
          <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 text-center">
                    <a href="<?= base_url();?>"><img src="<?= base_url();?>assets/img/oe-logo.png" alt="logo" width="180"></a> <br>
                    <br>
                    <h3 class="login-title">Create an Account</h3> <br>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input id="birthday" type="date" value="<?= set_value('birthday','',true)?>"
                       class="form-control <?php if(strlen(form_error('birthday')) > 0){echo "is-invalid";} ?>" name="birthday"
                       autofocus />
                <div class="invalid-feedback">
