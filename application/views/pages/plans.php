            ...
            <div class="form-group col-md-4 deposit-form">
						...
						<div class="form-group col-md-4 deposit-form">
							...
							<select class="form-control" name="plan_payment_mode">
								...
								<option <?php if($selected_mode == 'mode5') {echo 'selected';} ?> value="mode4">USD Digital</option>
								<option <?php if($selected_mode == 'mode7') {echo 'selected';} ?> value="mode7">OE Balance</option>
							</select>
							<div class="invalid-feedback">
