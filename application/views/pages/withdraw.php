        ...
        <div class="col-12">
          <div class="alert alert-info alert-has-icon">
            ...
            <div class="withdrawal-note">
              Minimum withdrawal amount is $20.00<br>
							Withdrawal requests are processed within 24 business hours and subject to 5% processing fee on top of the gross amount.
            </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                          ...
                          <option <?php if($selected_mode == 'mode1') {echo 'selected';} ?> value="mode1">Bank</option>
          								<option <?php if($selected_mode == 'mode2') {echo 'selected';} ?> value="mode2">Bitcoin</option>
													...
													<option <?php if($selected_mode == 'mode4') {echo 'selected';} ?> value="mode4">Bitcoin Cash</option>
          								<option <?php if($selected_mode == 'mode5') {echo 'selected';} ?> value="mode5">Stellar</option>
          							</select>
                      ...
                      <div class="form-group col-md-5 deposit-form">
          	            ...
          	            <input type="text" class="form-control <?php if(strlen(form_error('withdraw_amount')) > 0){echo "is-invalid";} ?>"
          								name="withdraw_amount" id="deposit-amount" placeholder="$ 0.00" value="<?php set_value('withdraw_amount','',true); ?>">
