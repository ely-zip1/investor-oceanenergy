...
INSERT INTO `td_banks` (`id`, `bank_name`, `account_name`, `account_number`, `member_id`, `country`) VALUES
(1, '', '', '', 4, ''),
(2, '', '', '', 5, '');
...
CREATE TABLE `td_withdrawal_mode` (
  ...
  `bitcoin_cash` text NOT NULL,
  `stellar` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `td_withdrawal_mode` (`id`, `member_id`, `bitcoin`, `ethereum`, `bitcoin_cash`, `stellar`) VALUES
(1, 4, '', '', '', ''),
(2, 5, '', '', '', '');
...
ALTER TABLE `td_members`
  ...
  ADD KEY `fk_member_referral_code` (`referral_code_id`);
...
ALTER TABLE `td_members`
  ...
  ADD CONSTRAINT `fk_member_referral_code` FOREIGN KEY (`referral_code_id`) REFERENCES `td_referral_codes` (`id`);
...
--
ALTER TABLE `td_withdrawals`
  ADD CONSTRAINT `fk_member_withdrawal` FOREIGN KEY (`member_id`) REFERENCES `td_withdrawals` (`id`);
